...
public class App {
    ...
    public static List swapFirstAndLast(ArrayList<String> strings) {
    ...
    public static List reverse(ArrayList<Integer> numbers) {
...
//            reversed.set(i) = numbers.get(numbers.size() - (i + 1));
    ...
    public static List lessThanFive(ArrayList<Integer> numbers) {
...
//                lessThan.add(lessThan.size() - numLessThanFive, num);
    ...
    public static void main(String[] args) {
        ...
        numbers.add(5);
        numbers.add(4);
        int totalNum = total((ArrayList<Integer>) numbers);
        ...
        strings.add("Delcie");
//        String swapNames =
//        List<String> swappedNames = new ArrayList();
//        List<String> strings.swapFirstAndLast(ArrayList<String> strings);
