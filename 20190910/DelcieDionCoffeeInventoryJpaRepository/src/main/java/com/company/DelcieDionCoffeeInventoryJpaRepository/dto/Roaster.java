...
//    public Roaster(int id, String name, String street, String city, String state, String postal_code, String phone, String email, String note, Set<Coffee> coffees) {
//        this.id = id;
//        this.name = name;
//        this.street = street;
//        this.city = city;
...
//    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, street, city, state, postal_code, phone, email, note, coffees);
    }
}
