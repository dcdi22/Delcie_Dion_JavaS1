...
public class RectPavingCompany {
    ...
    public static void main(String[] args) {
        ...
        framingCost = Float.parseFloat(scan.nextLine()); // Change variable to framingCost

        int area = length * width;
        int perimeter = 2*length + 2*width; //  2*length + 2*width
        ...
        System.out.format("The cost of the framing/footers is %f.%n", perimeter*framingCost); // perimeter*framingCost
    }
}
