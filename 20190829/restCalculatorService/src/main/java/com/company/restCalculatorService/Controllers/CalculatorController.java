...
public class CalculatorController  {
    ...
    public int getSum(@RequestBody Operands operands) throws NumberFormatException {
    ...
    @ResponseStatus(value = HttpStatus.CREATED)
    public int getDiff(@RequestBody Operands operands) throws NumberFormatException {
    ...
    @ResponseStatus(value = HttpStatus.CREATED)
    public int getProduct(@RequestBody Operands operands) throws NumberFormatException {
    ...
    @ResponseStatus(value = HttpStatus.CREATED)
    public int getQuo(@RequestBody Operands operands) throws NumberFormatException {
